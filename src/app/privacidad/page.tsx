export default function Privacy() {
  return (
    <div className="content-privacy">
      <div className="content-subtitle-privacy">
      ...
      <div>
        <p className="subtitle-privacy">2. Datos personales que recolectamos</p>
        <p className="text-privacy">Recolectamos los siguientes datos:</p>
        <ul className="list-privacy">
          <li className="text-list-privacy">Nombre completo</li>
          <li className="text-list-privacy">Correo electrónico</li>
          <li className="text-list-privacy">Número telefónico</li>
          <li className="text-list-privacy">Foto de perfil</li>
      ...
      <div>
        <p className="subtitle-privacy">3. Finalidades del tratamiento</p>
        <p className="text-privacy">Usamos tus datos personales para:</p>
        <ul className="list-privacy">
          <li className="text-list-privacy">
      ...
      <div>
        <p className="subtitle-privacy">4. Transferencia de datos</p>
        <p className="text-privacy">
      ...
      <div>
        <p className="subtitle-privacy">5. Derechos ARCO</p>
        <p className="text-privacy">
      ...
      <div>
        <p className="subtitle-privacy">6. Uso de tecnologías de rastreo</p>
        <p className="text-privacy">
      ...
      <div>
        <p className="subtitle-privacy">8. Seguridad de los datos</p>
        <p className="text-privacy">
      ...
      <div>
        <p className="subtitle-privacy">9. Información de pago</p>
        <p className="text-privacy">
      ...
      <div>
        <p className="subtitle-privacy">10. Cambios en esta política</p>
        <p className="text-privacy">
      ...
      <div className="content-subtitle-privacy">
        <p className="title-privacy">AVISO LEGAL / TÉRMINOS Y CONDICIONES</p>
      </div>
      <div>
        <p className="text-date">
      ...
      <div>
        ...
        <ul className="list-privacy">
          ...
          <li className="text-list-privacy">Resultados específicos de uso</li>
        </ul>
      </div>
      <div>
        <p className="subtitle-privacy">3. Obligaciones del usuario</p>
        <p className="text-privacy">El usuario se compromete a:</p>
        <ul className="list-privacy">
          <li className="text-list-privacy">
      ...
      <div>
        <p className="subtitle-privacy">6. Pagos</p>
        <p className="text-privacy">
          Los usuarios tipo proveedor deberán pagar una suscripción mensualpara
          acceder a funciones avanzadas. Los pagos se realizan mediante
      ...
      <div>
        <p className="subtitle-privacy">7. Cancelaciones y reembolsos</p>
        <p className="text-privacy">
      ...
      <div>
        <p className="subtitle-privacy">6. Modificaciones</p>
        <p className="text-privacy">
      ...
      <div>
        <p className="subtitle-privacy">9. Legislación aplicable</p>
        <p className="text-privacy">
